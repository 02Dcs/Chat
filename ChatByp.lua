...
if not getgenv().check then
    ...
    if (d.year <= 2023) then
        msg('Alt has been founded through the checker, you can use the script now');
        task.wait(1.8); msg('Undetectedable Chat bypass by 02#03000')
        task.wait(1.8); msg('02 Chat Byp Press F9 to read the informations')
    else
